...
do
    ...
    echo "python -m tpagb_calibration.sfhs.vary_sfh /home/rosenfield/research/TP-AGBcalib/SNAP/varysfh/$galaxy/$galaxy.vsfhinp > /home/rosenfield/research/TP-AGBcalib/SNAP/varysfh/$galaxy/$galaxy.vsfhout"
    wait
...
echo "python -m tpagb_calibration.sfhs.vary_sfh --dry_run /home/rosenfield/research/TP-AGBcalib/SNAP/varysfh/c2574-sgs/c2574-sgs_555.vsfhinp > /home/rosenfield/research/TP-AGBcalib/SNAP/varysfh/c2574-sgs/c2574-sgs_555.vsfhout"
...
do
    ...
    echo "python -m tpagb_calibration.sfhs.vary_sfh --dry_run /home/rosenfield/research/TP-AGBcalib/SNAP/varysfh/$galaxy/$galaxy_606.vsfhinp > /home/rosenfield/research/TP-AGBcalib/SNAP/varysfh/$galaxy/$galaxy_606.vsfhout &"
    wait
done
